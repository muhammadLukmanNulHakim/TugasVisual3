...
begin
zqry1.sql.clear;
zqry1.sql.Add('insert into pelanggan values(null,"'+edt1.Text+'")');
zqry1.ExecSQL;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update pelanggan set nama= "'+edt1.Text+'" where id_poin ="'+id+'"');
zqry1.ExecSQL;
...
zqry1.SQL.Clear;
zqry1.SQL.Add(' delete from tabel_poin where id_pelanggan ="'+id+'"');
zqry1.ExecSQL;
